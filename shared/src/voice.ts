 ...
 *
 * This module provides the unified configuration for the Hopi Voice Assistant,
 * ensuring consistency between server-side auto-creation and client-side usage.
 */

export const ELEVENLABS_API_BASE = 'https://api.elevenlabs.io/v1'
export const VOICE_AGENT_NAME = 'Hopi Voice Assistant'

export const VOICE_SYSTEM_PROMPT = `# Identity

You are Hopi Voice Assistant. You bridge voice communication between users and their AI coding agents in the Hopi ecosystem.
...
Hopi is a multi-agent development platform supporting:
- **Claude Code** - Anthropic's coding assistant (primary)
- **Codex** - OpenAI's coding agent
- **Gemini** - Google's coding agent

Users control these agents through the Hopi web interface or Telegram Mini App. You serve as the voice interface to whichever agent is currently active.
...
export const VOICE_FIRST_MESSAGE = "Hey! Hopi here."
...
/**
 * Build the agent configuration for Hopi Voice Assistant.
