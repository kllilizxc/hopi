...
export function SEO({ title, description, image, url }: SEOProps) {
  ...
  const siteTitle = "HOPI - Vibe Coding Anytime, Anywhere";
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="HOPI" />
