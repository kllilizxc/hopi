export const queryKeys = {
    ...
    projectAssistant: ['project-assistant'] as const,
    projectAssistantRoot: (projectId: string) => ['project-assistant', projectId] as const,
    projectAssistantSessions: (projectId: string, goalId?: string | null) => ['project-assistant', projectId, goalId ?? 'all'] as const,
